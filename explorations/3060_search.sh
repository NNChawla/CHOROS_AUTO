...
# --seed 42 --compile --eval_window_pool mean --eval_session_pool mean --eval_split_mode val --patch_size 6 --target_ratio 0.75 \
...
# --pred_ffn_dim 1024 --latent_loss smooth_l1 --embed_pool mean --lr 3e-4 --sampling_alpha 0.5 --dropout 0.5 --embed_dim 512 --n_heads 8 --n_layers 8 \
