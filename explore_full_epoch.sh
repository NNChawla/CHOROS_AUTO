...
--epochs 100 --embed_eval_interval 10 --batch_size 512 --num_workers 4 --precision bf16 --warmup_epochs 8 --val_fraction 0.1 --min_lr 1e-6 --kinematics PVAJ --samples_per_epoch 0 \
