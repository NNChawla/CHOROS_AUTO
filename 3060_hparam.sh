...
python training/hparam_search.py --gpu 1 --n_trials 200 --study_name 5_21_26_random_search --storage "postgresql://optuna:choroshps@app.arcadea.us/optuna_choros" \
    --worker_offset 3060 --skip_final --objective posejepa --compile --trial_timeout 7200 --batch_size 256 --compile \
